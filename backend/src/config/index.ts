...
export default {
  ...
  discord: {
    ...
    discordAuthorizationURL: devOrTest
      ? 'https://discordapp.com/oauth2/authorize?client_id=665375286031810571&permissions=8&redirect_uri=http%3A%2F%2Flocalhost%3A3000&response_type=code&scope=email%20identify'
      : 'https://discordapp.com/oauth2/authorize?client_id=665375286031810571&permissions=8&redirect_uri=https%3A%2F%2Ftrials.massimmersionapproach.com&response_type=code&scope=email%20identify'
  }
};
